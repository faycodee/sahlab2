...
const Schreiben = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setError("Failed to fetch SCHREIBEN data.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const confirmDelete = async (id) => {
    const confirmed = window.confirm(
      "Are you sure you want to delete this SCHREIBEN item?"
    );
    if (!confirmed) return;
    try {
        ...
        <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          <thead>
            <tr>
              ...
              <th className="px-6 py-3">Thema Name</th>
              <th className="px-6 py-3">Punkt 1</th>
              <th className="px-6 py-3">Punkt 2</th>
              <th className="px-6 py-3">Punkt 3</th>
