...
import HorenForm from "./pages/HorenForm"; // Import the new form component
    ...
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<DashboardLayout />}>
          ...
          <Route path="lesen/new" element={<LesenForm />} />{" "}
          {/* Route jdida l'Add */}
          <Route path="lesen/edit/:id" element={<LesenForm />} />{" "}
          {/* Route jdida l'Edit */}
          <Route path="horen" element={<Horen />} />
          <Route path="horen/new" element={<HorenForm />} />{" "}
          {/* Route jdida l'Add */}
          <Route path="horen/edit/:id" element={<HorenForm />} />{" "}
          {/* Route jdida l'Edit */}
